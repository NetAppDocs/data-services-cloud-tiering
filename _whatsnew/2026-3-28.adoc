=== NetApp Cloud Tiering no longer available in NetApp Console
NetApp Cloud Tiering is no longer available for purchase or license renewal as of April 26, 2026.

Existing customers can continue to use NetApp Cloud Tiering until their subscription or license contract expires. Customers with active subscriptions can continue to receive support and until their subscription expires. After the subscription expires, customers will no longer have access to NetApp Cloud Tiering features or support.
